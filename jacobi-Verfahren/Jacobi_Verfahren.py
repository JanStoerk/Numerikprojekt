'''Vorbereitung in eine Diagonalmatrix D, 
eine strikte untere Dreiecksmatrix L 
und eine strikte obere Dreiecksmatrix U zerlegt'''
...
for i in range(11):
    ...
    print("Das Ergebnisvektor lautet:", result_vector)